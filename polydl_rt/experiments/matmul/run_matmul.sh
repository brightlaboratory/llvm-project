...
TEMP=temp
DATATYPESIZE=4
POLYSCIENTIST=/nfs_home/stavarag/work/polyscientist/data_reuse_analyzer/polyscientist
...
config=${iters}_${M1}_${N1}_${K1}__${M2_Tile}_${N2_Tile}_${K2_Tile}_${M1_Tile}_${N1_Tile}_${K1_Tile}_${Step_M}_${Step_N}_${Step_K}_${PARALLEL_LOOP}_${NUM_THREADS}
echo config: $config
